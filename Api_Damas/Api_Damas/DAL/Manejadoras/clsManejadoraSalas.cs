...
namespace Api_Damas.DAL.Manejadoras
{
    public class clsManejadoraSalas
    {
        ...
        public static int editarSalaDAL(clsSala sala)
        {
            ...
            miComando.Parameters.Add("@espacio", System.Data.SqlDbType.Int).Value = sala.espacio;
            ...
            {
                conexion = miConexion.getConnection();
                miComando.CommandText = "UPDATE Salas SET nombreSala=@nombreSala, jugadorArriba=@jugadorArriba, jugadorAbajo=@jugadorAbajo, tiempo=@tiempo, fichasArriba=@fichasArriba, fichasAbajo=@fichasAbajo, espacio=@espacio FROM Departamentos WHERE ID=@id";
                miComando.Connection = conexion;
                numeroFilasAfectadas = miComando.ExecuteNonQuery();
            }
            catch (SqlException)
        ...
        public static int insertarSalaDAL(clsSala sala)
        {
            ...
            {
                conexion = miConexion.getConnection();
                miComando.CommandText = "INSERT INTO Salas VALUES(@nombreSalas, @jugadorArriba, @jugadorAbajo, @tiempo, @cantidadFichasArriba, @cantidadFichasAbajo, @espacio)";
                miComando.Connection = conexion;
                numeroFilasAfectadas = miComando.ExecuteNonQuery();
            }
            catch (SqlException)
